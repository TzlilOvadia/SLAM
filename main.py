...
if __name__ == "__main__":
    ...
    #pnp_solver.get_relative_estimation_error(mode="PNP", path_suffix="pnp", invert_estimated_poses=False)
    ...
    #bundle_adjustment_solver.show_factor_errors_and_reprojection_errors_by_distance(length=15)
    #bundle_adjustment_solver.get_relative_estimation_error(mode="BUNDLE_ADJUSTMENT", path_suffix="bundle_adjustment", invert_estimated_poses=True)
    ...
    loop_closure_solver = LoopClosure(force_recompute=True)
    loop_closure_solver.solve_trajectory()
    loop_closure_solver.show_num_matches_and_inliers_per_lc()
    loop_closure_solver.get_relative_estimation_error(mode="LOOP_CLOSURE", path_suffix="loop_closure", invert_estimated_poses=True)
    ...
    pnp_solver.get_absolute_estimation_error(path="pnp_absolute_estimation_error", mode="PNP", invert_estimated_poses=False)
    bundle_adjustment_solver.get_absolute_estimation_error(path="bundle_adjustment_absolute_estimation_error", mode="BUNDLE ADJUSTMENT", invert_estimated_poses=True)
    loop_closure_solver.get_absolute_estimation_error(path="loop_closure_absolute_estimation_error", mode="LOOP_CLOSURE", invert_estimated_poses=True)
