...
if __name__ == "__main__":
    ...
    #pnp_solver.get_relative_estimation_error(mode="PNP", path_suffix="pnp")
    ...
    #bundle_adjustment_solver.get_relative_estimation_error(mode="BUNDLE_ADJUSTMENT", path_suffix="bundle_adjustment")
    ...
    #loop_closure_solver.get_relative_estimation_error(mode="LOOP_CLOSURE", path_suffix="loop_closure")
